...
@WebServlet("/userpostcontrol")
public class userpostcontrol extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		hello a = new hello();
		try {
			ResultSet b = a.doselect("select postid,title,body,created from post where author=?;",userid);
				while (b.next()) {
